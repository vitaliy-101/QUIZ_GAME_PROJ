...
public class SoloGame_5_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_5_3);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("петр") || ans_st.equals("пётр") ||ans_st.equals("петр ") || ans_st.equals("пётр ")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_5_3.this, SoloGame_5_4.class);
        ...
        //вопрос
        tv_quest.setText("Напишите ИМЯ первого русского императора");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_5_3.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
