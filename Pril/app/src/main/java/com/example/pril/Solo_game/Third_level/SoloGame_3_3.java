...
public class SoloGame_3_3 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_3_3);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_3_3.this, SoloGame_3_4.class);
            ...
            //вопрос
            tv_quest.setText("Какая буква должна идти после знака вопроса?\n" +
                    "А, В, Е, И, Н, ?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_3_3.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
