...
public class SoloGame_8_2 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_8_2);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("1703") || ans_st.equals(" 1703") ||ans_st.equals("1703 ")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_8_2.this, SoloGame_8_3.class);
        ...
        //вопрос
        tv_quest.setText("В каком году был основан Санкт - Петербург?");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_8_2.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
