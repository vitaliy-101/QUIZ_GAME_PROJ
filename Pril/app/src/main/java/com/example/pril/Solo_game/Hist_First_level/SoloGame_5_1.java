package com.example.pril.Solo_game.Hist_First_level;
...
public class SoloGame_5_1 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_5_1);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_5_1.this, SoloGame_5_2.class);
        ...
        //вопрос
        tv_quest.setText("Кто изображен на картине?");
        tv_points.setText("Очки: " + String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_5_1.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
