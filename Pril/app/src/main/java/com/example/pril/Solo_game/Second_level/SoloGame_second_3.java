...
public class SoloGame_second_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_second_3);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("часы") || ans_st.equals("час")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_3.this, SoloGame_second_4.class);
        ...
        //вопрос
        tv_quest.setText("Что может в одно и то же время\n" +
                "ходить, висеть, лежать и стоять?");
        tv_points.setText("Очки: "+String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_3.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
