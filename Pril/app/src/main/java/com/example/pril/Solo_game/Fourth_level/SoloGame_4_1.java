...
public class SoloGame_4_1 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_4_1);
            ...
            b1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    tv_points.setText(String.valueOf(points)+"/5");
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_4_1.this, SoloGame_4_2.class);
            ...
            //вопрос
            tv_quest.setText("У фермера было 17 овец, и все, кроме девяти,\n" +
                    "умерли. Сколько овец осталось у фермера?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_4_1.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
