...
public class SoloGame_6_3 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_6_3);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_6_3.this, SoloGame_6_4.class);
            ...
            //вопрос
            tv_quest.setText("Александр Невский участвовал в этом событии в 1242 году.\n" +
                    "Что это за битва?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_6_3.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
