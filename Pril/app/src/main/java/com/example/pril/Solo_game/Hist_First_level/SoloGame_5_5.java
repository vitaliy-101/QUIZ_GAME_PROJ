...
public class SoloGame_5_5 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_5_5);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_5_5.this, SoloGame_itog.class);
        ...
        //вопрос
        tv_quest.setText("Какое событие изображено на картине?");
        tv_points.setText("Очки: " + String.valueOf(points));
        Go_thread();
