...
public class SoloGame_4_2 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_4_2);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("эверест") || ans_st.equals(" эверест") ||ans_st.equals("эверест ")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_4_2.this, SoloGame_4_3.class);
        ...
        //вопрос
        tv_quest.setText("Какая гора была самой высокой до открытия Эвереста?");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_4_2.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
