...
public class SoloGame_long1_1 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_long1_1);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    is_started = false;
                    Intent intent = new Intent(SoloGame_long1_1.this, SoloGame_long1_2.class);
            ...
            //вопрос
            tv_quest.setText("Решите:\n" +
                    "144^0.5 * 2 / 4 * 81^0.5 - (9+16)^0.5");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_long1_1.this, Long_game.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
