...
public class SoloGame_first_4 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_first_4);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_4.this, SoloGame_first_5.class);
        ...
        tv_quest.setText("Каким числом следует заменить знак вопроса?\n" +
                "5 2 4 6\n" +
                "3 4 5 7\n" +
                "8 3 6 ? ");
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_4.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
