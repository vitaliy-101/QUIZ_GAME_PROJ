package com.example.pril.Solo_game.First_level;
...
public class SoloGame_first_5 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_first_5);
        //получаем количество очков из прошлого активити
        Intent intent = getIntent();
        points_st = intent.getStringExtra("POINTS");
        points = Integer.parseInt(points_st) + points;
        //
        ...
        b3.setOnClickListener(new View.OnClickListener() {//Правильно
            @Override
            public void onClick(View v) {
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_5.this, SoloGame_itog.class);
                intent.putExtra("POINTS",String.valueOf(points));
                intent.putExtra("GAME", "ЛОГИКА");
        ...
        tv_quest.setText("Из какого слова можно удалить одну 'букву',\n" +
                " чтобы осталось только две буквы?");
        tv_points.setText("Очки: " + String.valueOf(points));//мб
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_5.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
