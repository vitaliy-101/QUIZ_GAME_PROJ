package com.example.pril.Solo_game.Hist_Third_level;
...
public class SoloGame_7_5 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_7_5);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_7_5.this, SoloGame_itog.class);
        ...
        //вопрос
        tv_quest.setText("В каком веке основан этот город?");
        tv_points.setText("Очки: " + String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_7_5.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
