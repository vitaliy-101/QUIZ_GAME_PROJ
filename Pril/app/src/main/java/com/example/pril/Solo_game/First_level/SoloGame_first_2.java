...
public class SoloGame_first_2 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_first_2);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_2.this, SoloGame_first_3.class);
                intent.putExtra("POINTS",String.valueOf(points));
                startActivity(intent);
                finishAffinity();
            }
        });
        tv_quest.setText("Сколько месяцев в году имеют 28 дней?");
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_first_2.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
