...
public class SoloGame_long1_3 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_long1_3);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("2") || ans_st.equals("2 ") ||ans_st.equals(" 2")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                is_started = false;
                Intent intent = new Intent(SoloGame_long1_3.this, SoloGame_long1_4.class);
        ...
        //вопрос
        tv_quest.setText(" При составлении расписания на пятницу были высказаны пожелания,\n" +
                "чтобы информатика была первым или вторым уроком, физика — первым или третьим,\n" +
                "история — вторым или третьим.\n" +
                "Сколько вариантов удовлетворения одновременно всех высказанных пожеланий?");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_long1_3.this, Long_game.class);
                startActivity(intent);
                finishAffinity();
            }
        });
