...
public class SoloGame_5_4 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_5_4);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_5_4.this, SoloGame_5_5.class);
            ...
            //вопрос
            tv_quest.setText("Отметьте даты начала и конца \n" +
                    "Северной войны");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_5_4.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
