package com.example.pril.Solo_game.Second_level;
...
public class SoloGame_second_5 extends AppCompatActivity {
    private TextView tv_points;
    private TextView tv_timer;
    private ImageView im_quest;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_second_5);
        ...
        im_quest = findViewById(R.id.im_quest);
        //
        toolbar1();
        //вызов и использование элементов


        b1.setOnClickListener(new View.OnClickListener() {//ПРАВИЛЬНО, ОСТАЛЬНОЕ НЕТ
            @Override
            public void onClick(View v) {//ПРАВИЛЬНО
                points += 1;
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_5.this, SoloGame_itog.class);
        ...
        //вопрос
        tv_quest.setText("Какой номер у парковочного места\n" +
                "под машиной?");
        tv_points.setText("Очки: " + String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_5.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
