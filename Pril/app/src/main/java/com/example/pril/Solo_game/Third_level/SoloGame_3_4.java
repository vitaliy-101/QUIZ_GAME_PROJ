...
public class SoloGame_3_4 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_3_4);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("13") || ans_st.equals(" 13") ||ans_st.equals("13 ")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_3_4.this, SoloGame_3_5.class);
        ...
        //вопрос
        tv_quest.setText("Полтора судака стоят полтора рубля.\n" +
                "Сколько стоят 13 судаков? (рублей)");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_3_4.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
