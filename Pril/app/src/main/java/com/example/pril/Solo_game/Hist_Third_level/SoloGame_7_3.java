...
public class SoloGame_7_3 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_7_3);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_7_3.this, SoloGame_7_4.class);
            ...
            //вопрос
            tv_quest.setText("Какие города основаны в 12 веке?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_7_3.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
