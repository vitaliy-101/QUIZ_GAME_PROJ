...
public class SoloGame_second_1 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_second_1);
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_1.this, SoloGame_second_2.class);
        ...
        //вопрос
        tv_quest.setText("В отеле 5 этажей. Чем выше этаж,\n" +
                "тем больше людей там живет.\n" +
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_second_1.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
