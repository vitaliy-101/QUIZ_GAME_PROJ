...
public class SoloGame_6_1 extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sologame_6_1);
        ...
        go_ans.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans_st.equals("михаил") || ans_st.equals(" михаил") ||ans_st.equals("михаил ")){
        ...
        b_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_6_1.this, SoloGame_6_2.class);
        ...
        //вопрос
        tv_quest.setText("Напишите ИМЯ первого царя из династии Романовых");
        tv_points.setText("Очки: "+ String.valueOf(points));
        Go_thread();
    ...
    private void toolbar1() {
        ...
        left_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count = 20;
                is_started = false;
                Intent intent = new Intent(SoloGame_6_1.this, SoloGame_menu.class);
                startActivity(intent);
                finishAffinity();
            }
        });
