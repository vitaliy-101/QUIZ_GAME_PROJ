...
public class SoloGame_6_2 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_6_2);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_6_2.this, SoloGame_6_3.class);
            ...
            //вопрос
            tv_quest.setText("В каком веке основан Нью-Йорк?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_6_2.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
