...
public class SoloGame_3_1 extends AppCompatActivity {
        ...
        public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            setContentView(R.layout.sologame_3_1);
            ...
            b_next.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_3_1.this, SoloGame_3_2.class);
            ...
            //вопрос
            tv_quest.setText("Что не вместится даже в самую большую кастрюлю?");
            tv_points.setText("Очки: "+String.valueOf(points));
            Go_thread();
        ...
        private void toolbar1() {
            ...
            left_icon.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    count = 20;
                    is_started = false;
                    Intent intent = new Intent(SoloGame_3_1.this, SoloGame_menu.class);
                    startActivity(intent);
                    finishAffinity();
                }
            });
